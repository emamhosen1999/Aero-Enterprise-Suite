...
/**
 * Ambient background aurora for the Aeon console.
 * Rendered onto a canvas with drifting glowing color blobs.
 */
export default function AeonAura() {
  ...
  useEffect(() => {
    ...
    const blobs = [
      { x: 0.2, y: 0.25, r: 0.55, c: () => hexToRgb(accent()), p: 0 },
      { x: 0.85, y: 0.15, r: 0.45, c: () => [140, 107, 255], p: 2 },
      { x: 0.75, y: 0.90, r: 0.50, c: () => [255, 102, 196], p: 4 },
    ];
